  ...
  return (
    <div>
      <Grid container spacing={2} sx={{ padding: "3% 5%", }}>
        ...
        <Grid item xs={12} sx={{ marginBottom: "2.5rem", textAlign: "justify" }}>
          <div style={{ fontSize: "1.25rem", fontWeight: "500" }}>
        <p>  Being the Varishth Mandal it is prime duty to bring transparency in the functioning of Gnati. The upliftment of Gnati and take the gnati to the next level by participation of more and more gnatijan and bring them in the main stream of the gnati. Further, it is our duty to align the youth of the gnati to the mainstream and participate in the ganti activiely.  
The Committee has been formed with main focus on 3T <p>
•	Transformation
•	Technology
•	Transparency
