...
<Grid item xs={12}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4} sm={6} style={{ backgroundColor: "#CEF5D3" }}>
            ...
            <Grid item xs={12} md={4} sm={6} style={{ backgroundColor: "#DFFCD9" }}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
            ...
            <Grid item xs={12} md={12} sm={6} style={{ backgroundColor: "#D8D5ED" }}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
