...
class _AddEventFormState extends State<AddEventForm> {
  ...
  void initState() {
    ...
    if (widget.preFilledData != null) {
      nameController = TextEditingController(text: widget.preFilledData['name']);
      aboutController = TextEditingController(text: widget.preFilledData['about']);
      dateController = TextEditingController(text: widget.preFilledData['date']);
      startTimeController = TextEditingController(text: widget.preFilledData['startTime']);
      endTimeController = TextEditingController(text: widget.preFilledData['endTime']);
      venueController = TextEditingController(text: widget.preFilledData['venue']);
      photosDriveController = TextEditingController(text: widget.preFilledData['photosDrive']);
    }
    super.initState();
  }
                    ...
                    onTap: () async {
                      ...
                      if (pickedTime != null) {
                        setState(() {
                          ...
                          startTimeController.text = "${pickedTime.hour}:${pickedTime.minute}:00";
                        });
                      } else {
                    ...
                    onTap: () async {
                      ...
                      if (pickedTime != null) {
                        setState(() {
                          ...
                          endTimeController.text = "${pickedTime.hour}:${pickedTime.minute}:00";
                        });
                      } else {
                        print("Time is not selected");
                      }
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        var res = await eventService.addEvent(
                          ...
                          startTime: dateController.text + "T" + startTimeController.text,
                          endTime: dateController.text + "T" + endTimeController.text,
