...
class EditCompanyDetails extends StatefulWidget {
  const EditCompanyDetails({super.key, this.preFilledData});
...
class _EditCompanyDetailsState extends State<EditCompanyDetails> {
  ...
  void initState() {
    ...
    _companyNameController.text = widget.preFilledData['name'];
    _companyAddressController.text = widget.preFilledData['address'];
    _companyEmailController.text = widget.preFilledData['email'];
    super.initState();
  }
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: profilePic != null
                          ...
                          : companyDetailsService.companyPhoto != ""
                              ? Image.network(
                                  kbaseUrlImage +
                                      companyDetailsService.companyPhoto,
                                  width: 100,
                    ...
                    child: InkWell(
                      onTap: () async {
                        ...
                        if (_companyEmailController.text.isEmpty) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text("Please enter company email"),
                            ),
                          );
                          return;
                        }
                        ...
                        var res = await companyDetailsService.editMyCompany(
                        ...
                        if (res) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text("Couldn't Update Details"),
                            ),
                          );
                        }
                      },
